        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-8">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-2 sm:mb-4 leading-tight">
              {getTranslatedTitle(attraction, attraction.title, language)}
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-12">
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-8">
            {/* Description */}
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">{t("about")}</h2>
              <div className="prose prose-green max-w-none">
                {formatDescription(getTranslatedDescription(attraction, attraction.description, language))}
              </div>
            </div>
            ...
            {attraction.highlights && attraction.highlights.length > 0 && (
              <div>
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">{t("highlights")}</h2>
            ...
            {/* Details Grid */}
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">{t("information")}</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                {attraction.capacity && (
                  <div className="flex items-center gap-3 p-3 sm:p-4 border rounded-lg">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900 text-sm sm:text-base">{t("capacity")}</div>
                ...
                {attraction.price && (
                  <div className="flex items-center gap-3 p-3 sm:p-4 border rounded-lg">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900 text-sm sm:text-base">{t("priceTitle")}</div>
            ...
            <Card className="lg:sticky lg:top-6">
              <CardContent className="p-4 sm:p-6">
                <div className="text-center mb-4 sm:mb-6">
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">{t("interested")}</h3>
                ...
                <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                  ...
                  {attraction.price && (
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600 text-sm">{t("priceTitle")}:</span>
