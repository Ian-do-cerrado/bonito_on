...
export async function getAllPackages(supabase: SupabaseClient = defaultClient): Promise<Package[]> {
  try {
...
export async function getPackageBySlug(slug: string, supabase: SupabaseClient = defaultClient): Promise<Package | null> {
  try {
...
function transformDatabasePackage(dbPackage: any): Package {
  return {
    ...
    title_en: dbPackage.title_en || "",
    subtitle_en: dbPackage.subtitle_en || "",
    description_en: dbPackage.description_en || "",
    title_es: dbPackage.title_es || "",
    subtitle_es: dbPackage.subtitle_es || "",
    description_es: dbPackage.description_es || "",
    duration: dbPackage.duration,
    price: dbPackage.price,
    originalPrice: dbPackage.original_price,
    image: resolveImageUrl(dbPackage.image),
