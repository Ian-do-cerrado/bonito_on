...
import { getTranslatedPackageTitle, getTranslatedPackageSubtitle, getTranslatedPackageDescription } from "@/lib/dynamic-translations"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredPackages.map((pkg) => (
                <Card key={pkg.id} className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                  ...
                  <CardHeader>
                    <CardTitle className="text-xl">{getTranslatedPackageTitle(pkg, pkg.title, language)}</CardTitle>
                    <p className="text-gray-600">{getTranslatedPackageSubtitle(pkg, pkg.subtitle || "", language)}</p>
                  </CardHeader>

                  <CardContent>
                    <p className="text-gray-700 mb-4 line-clamp-3">{getTranslatedPackageDescription(pkg, pkg.description, language)}</p>
